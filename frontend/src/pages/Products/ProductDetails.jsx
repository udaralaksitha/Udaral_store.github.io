          ...
          <div className="flex flex-wrap relative items-between mt-[2rem] ml-[10rem]">
            <div>
              <img
                src={product.image}
                alt={product.name}
                className="w-full xl:w-[35rem] lg:w-[45rem] md:w-[30rem] sm:w-[20rem] mr-[2rem]"
              />
                <HeartIcon product={product} />
            </div>

            <div className="flex flex-col justify-between">
              <h2 className="text-1xl font-semibold">{product.name}</h2>
              <p className="my-1 xl:w-[35rem] lg:w-[35rem] md:w-[30rem] text-[#B0B0B0]">
                {product.description.substring(0, 220)}...
              </p>

              <p className="text-5xl my-2 font-extrabold">$ {product.price}</p>
              ...
              {product.countInStock > 0 && (
                  <div>
                    <select
                      ...
                      className="p-1 w-[5rem] rounded-lg text-black mb-2 mr-12"
                    >
